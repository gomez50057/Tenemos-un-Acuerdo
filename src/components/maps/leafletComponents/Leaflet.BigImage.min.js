!function (t, i) {
  "function" == typeof define && define.amd ? define(["leaflet"], t) : "object" == typeof exports && (module.exports = t(require("leaflet"))),
    void 0 !== i && i.L && (i.L.YourPlugin = t(L))
}(function (t) {
  t.Control.BigImage = t.Control.extend({
    options: {
      ...
      printControlLabel: "\uD83D\uDDA8️",
      printControlClasses: [],
      printControlTitle: "Imprimir mapa",
      _unicodeClass: "bigimage-unicode-icon",
      maxScale: 10,
      minScale: 1,
      inputTitle: "Elige escala:",
      downloadTitle: "Descargar"
    },
    onAdd: function (t) {
      this._map = t;
      let i = this.options.printControlTitle,
        e = this.options.printControlLabel,
        n = this.options.printControlClasses;
      return - 1 != e.indexOf("&") && n.push(this.options._unicodeClass),
        this._createControl(e, i, n, this._click, this)
    },
    _click: function (t) {
    ...
    _createControl: function (i, e, n, o, s) {
      this._container = document.createElement("div"),
        ...
        this._container.classList.add("bigimage"),
      ...
      return a.style.width = "100%",
        ...
        this._createControlPanel(n, s, i, e, o),
    ...
    _getTileLayer: function (i, e) {
      let n = this;
      n.tiles = [],
        n.tileSize = i._tileSize.x,
        n.tileBounds = t.bounds(n.bounds.min.divideBy(n.tileSize)._floor(), n.bounds.max.divideBy(n.tileSize)._floor());
    ...
    _getPathLayer: function (i, e) {
      ...
      Array.isArray(a[0]) && (a = a.flat()),
        a.forEach(i => {
          let e = n._map.project(i);
          e = e.subtract(new t.Point(n.bounds.min.x, n.bounds.min.y)),
            s.push(e),
            e.x < n.canvas.width && e.y < n.canvas.height && (o = 1)
        }),
        o && (n.path[i._leaflet_id] = {
          parts: s,
          closed: i.options.fill,
          options: i.options
        }),
        e()
    },
    _changeScale: function (t) {
      if (!t || t <= 1)
        return 0;
      let i = (this.bounds.max.x - this.bounds.min.x) / 2 * (t - 1),
        e = (this.bounds.max.y - this.bounds.min.y) / 2 * (t - 1);
      this.bounds.min.x -= i,
        this.bounds.min.y -= e,
        this.bounds.max.x += i,
        this.bounds.max.y += e,
    ...
    _drawText: function (t, i) {
      ...
      this.ctx.font = "regular 16px arial",
        ...
        this.ctx.fillText(t.html.nodeValue, t.x, t.y),
    ...
    _drawCircle: function (i, e) {
      ...
      let o = Math.max(Math.round(i._radius), 1),
        s = (Math.max(Math.round(i._radiusY), 1) || o) / o;
      1 !== s && (this.ctx.save(), this.scale(1, s)),
        this.ctx.beginPath(),
        this.ctx.arc(n.x, n.y / s, o, 0, 2 * Math.PI, !1),
        1 !== s && this.ctx.restore(),
        this._feelPath(i.options)
    },
    _feelPath: function (t) {
      t.fill && (this.ctx.globalAlpha = t.fillOpacity, this.ctx.fillStyle = t.fillColor || t.color, this.ctx.fill(t.fillRule || "evenodd")),
        t.stroke && 0 !== t.weight && (this.ctx.setLineDash && this.ctx.setLineDash(t && t._dashArray || []), this.ctx.globalAlpha = t.opacity, this.ctx.lineWidth = t.weight, this.ctx.strokeStyle = t.color, this.ctx.lineCap = t.lineCap, this.ctx.lineJoin = t.lineJoin, this.ctx.stroke())
    },
    _print: function () {
      let t = this;
      t.tilesImgs = {},
      ...
      t.zoom = t._map.getZoom(),
        ...
        new Promise(function (i, e) {
          ...
          for (let [n, o] of Object.entries(t.tilesImgs))
            for (let [s, a] of Object.entries(o)) t.ctx.drawImage(a.img, a.x, a.y, t.tileSize, t.tileSize);
          for (let [l, c] of Object.entries(t.path)) t._drawPath(c);
          for (let [r, h] of Object.entries(t.markers)) h instanceof HTMLImageElement || h.img ? t.ctx.drawImage(h.img, h.x, h.y) : t._drawText(h, h.x, h.y);
          for (let [d, p] of Object.entries(t.circles)) t._drawCircle(p);
          i()
        })).then(() => {
          let i = new Image;
          i.onload = () => {
            let e = .6 * t.canvas.width,
              n = e / i.width * i.height;
            t.ctx.drawImage(i, 10, 10, e, n),
              t.canvas.toBlob(function (t) {
                let i = document.createElement("a");
                i.download = "Mapa_SIMRH.png",
                  i.href = URL.createObjectURL(t),
                  i.click()
              })
          },
            i.src = "img/Logox2.webp",
