      ...
      {!isCollapsed ? (
        <div className={styles.chatbotWelcome}>
          ...
          <div className={styles.content}>
            <img src="img/headertxt.png" alt="Tenemos un Acuerdo " className={styles.logotxt} />
            <img src="img/sidebarRecurso.png" alt="Chatbot Logo" className={styles.logo} />
            <h1 className={styles.title}>¡Hola!, Bienvenid@ al</h1>
            <h2 className={styles.subtitle}>Chatbot de <span>Tenemos un Acuerdo</span></h2>
            <p className={styles.description}>Un asistente Ciudadana</p>
          </div>
        ...
        <img src="img/sidebarRecurso.png" alt="Chatbot Logo" className={styles.logoCollapsed} onClick={handleToggleCollapse} />
      )}
    </>
  );
};
