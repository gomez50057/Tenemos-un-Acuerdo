...
export const foroOptions = [
  { label: "Foro de Ciencias", value: "ciencias" },
  { label: "Foro de Tecnología", value: "tecnologia" },
  { label: "Foro de Cultura", value: "cultura" },
  { label: "Foro de Deportes", value: "deportes" },
  { label: "Foro de Juventud", value: "juventud" },
];

export const grupoOptions = [
  { label: "Artistas y creadores culturales", value: "Artistas y creadores culturales" },
  { label: "Campesinos y trabajadores del campo", value: "Campesinos y trabajadores del campo" },
  { label: "Deportistas", value: "Deportistas" },
  { label: "Estudiante", value: "Estudiante" },
  { label: "Emprendedores y empresarios", value: "Emprendedores y empresarios" },
  { label: "Juventudes", value: "Juventudes" },
  { label: "Migrantes", value: "Migrantes" },
  { label: "Mujeres", value: "Mujeres" },
  { label: "Obreros", value: "Obreros" },
  { label: "Personas con discapacidad", value: "Personas con discapacidad" },
  { label: "Personas de la tercera edad", value: "Personas de la tercera edad" },
  { label: "Personas LCBTIQ+", value: "Personas LCBTIQ+" },
  { label: "Pueblos y comunidades indígenas", value: "Pueblos y comunidades indígenas" },
  { label: "Personas con enfermedades crónicas", value: "Personas con enfermedades crónicas" },
  { label: "Voluntarios y activistas", value: "Voluntarios y activistas" },
];